...
CELL_TYPE_DICT = {
                'small cell lung carcinoma': ["epithelial cell of lower respiratory tract", "epithelial cell", "T cell"],
                'lung large cell carcinoma': ['native cell', 'CD8-positive, alpha-beta T cell'],
                'non-small cell lung carcinoma': ['epithelial cell of lower respiratory tract','malignant cell', 'CD8-positive, alpha-beta T cell'],
                'lung adenocarcinoma': ['CD8-positive, alpha-beta T cell', 'malignant cell', "epithelial cell of lower respiratory tract"], 
                'glioblastoma': ['malignant cell', 'oligodendrocyte precursor cell', "microglial cell"],
                }
...
for disease in diseases:
    required_cells = {comb: {"normal":int(1e3), disease: int(1e3)}[comb[0]] for comb in [(d, c, t, 'yes') for d in ['normal', disease] for c in CELL_TYPE_DICT[disease] for t in TISSUE_DICT[disease]] if not ((comb[0] == "normal" and comb[1] == "malignant cell") or (comb[0] == "normal" and comb[1] == "epithelial cell"))}
