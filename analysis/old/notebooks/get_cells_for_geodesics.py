...
diseases = ['Alzheimer disease', 'Parkinson disease','myocardial infarction', 'dilated cardiomyopathy']
...
model, tokenizer = load_trained_model("../../../runs/gesam_polygene_run_4/", checkpoint_n=0)
...
for disease in diseases:
    required_cells = {comb: 5000 for comb in [(d, c, t, 'yes') for d in ['normal', disease] for c in CELL_TYPE_DICT[disease] for t in TISSUE_DICT[disease]]}
    ...
    result_path = EMBEDDINGS_DIR + f'{disease}_0_cells.h5ad'
    ...
    pd.to_pickle(embeddings, EMBEDDINGS_DIR + f"{disease}_0_embeddings.pkl")
