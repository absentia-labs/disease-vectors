...
pd.to_pickle(results, EMBEDDINGS_DIR + f"disease_vector_results_{cell_count}_{cell_count_vectors}.pkl")
...
#pd.to_pickle(similarity_matrices, EMBEDDINGS_DIR + "disease_vector_similarity_matrices_large.pkl")
